...
def load_config(config_path="config/vqgan_2d_big.yaml"):
...
def run(cfg):
    ...
    dataloader = patch_train_maskdataloader(dataset, patch_size=(224, 224, 5), batch_size=cfg.batch_size, samples_per_volume=128)
